...
const questions = [
    ...
    },
    {
    ...
    },
     {
        ...
        options: ["Europa", "Titan", "Moon", "Phobos"],
        correctAnswerIndex: 2
    }
...
const correctSoundEffect = new Audio('Correct Answer sound effect.mp3');
const incorrectSoundEffect = new Audio('Wrong Answer Sound effect.mp3');

// this elements for audio

function playCorrectSound() {
    correctSoundEffect.currentTime = 0;
    correctSoundEffect.play().catch(error => {
        //console.log("Error Playing Correct Answer", error);
    });
}
...
function playIncorrectSound() {
    ...
    incorrectSoundEffect.play().catch(error => {
        //console.log("Error Playing Incorrect Answer",error);
    });
}
